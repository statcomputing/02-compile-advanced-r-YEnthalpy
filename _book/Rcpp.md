...
add
#> function (x, y, z) 
#> .Call(<pointer: 0x1103aed10>, x, y, z)
add(1, 2, 3)
#> [1] 6
```
...
#> 1 sum(x)       1.16µs    1.2µs   723768.        0B     0   
#> 2 sumC(x)      2.44µs   4.28µs   246724.    2.49KB     0   
#> 3 sumR(x)     32.49µs  32.92µs    28613.  182.59KB     2.86
```
...
#>   expression          min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>     <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 pdistR(0.5, y)   6.86ms   7.04ms      135.    7.63MB     60.6
#> 2 pdistC(0.5, y)   3.13ms   3.19ms      305.    7.63MB    153.
```
...
#>   expression              min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>         <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 gibbs_r(100, 10)     5.22ms   5.48ms      174.    4.97MB     34.2
#> 2 gibbs_cpp(100, 10) 252.13µs 273.62µs     3544.     4.1KB     21.9
```
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 vacc1        1.94ms   2.01ms      479.    7.86KB     25.1
#> 2 vacc2       56.97µs  62.58µs    14223.  148.84KB     23.6
#> 3 vacc3        12.3µs  13.16µs    73883.   14.48KB     22.2
```
