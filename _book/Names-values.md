...
```r
ref(l1, l2)
#> █ [1:0x7fa51ee95898] <list> 
#> ├─[2:0x7fa51f0237b0] <dbl> 
#> ├─[3:0x7fa51f023778] <dbl> 
#> └─[4:0x7fa51f023740] <dbl> 
#>  
#> █ [5:0x7fa51be47348] <list> 
#> ├─[2:0x7fa51f0237b0] 
#> ├─[3:0x7fa51f023778] 
#> └─[6:0x7fa51c678088] <dbl>
```
...
#> █ [1:0x7fa51e42e088] <chr> 
#> ├─[2:0x7fa51894aeb0] <string: "a"> 
#> ├─[2:0x7fa51894aeb0] 
#> ├─[3:0x7fa51e4154c8] <string: "abc"> 
#> └─[4:0x7fa51a8a9078] <string: "d">
```
...
ref(e)
#> █ [1:0x7febce0a2be0] <env> 
#> └─self = [1:0x7febce0a2be0]
```
...
#> Ncells  756026 40.4    1343265  71.8         NA  1343265 71.8
#> Vcells 4805453 36.7   15215194 116.1      16384 12456141 95.1
```
