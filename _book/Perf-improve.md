...
#> 1 mean1(x)    186.1µs  188.1µs     5037.
#> 2 mean2(x)     92.3µs   92.7µs    10302.
```
...
#>   expression           min   median `itr/sec`
#>   <bch:expr>      <bch:tm> <bch:tm>     <dbl>
#> 1 mean(x)           2.69µs   3.65µs   230138.
#> 2 mean.default(x)    1.4µs   1.59µs   528109.
```
...
#>   expression              min   median `itr/sec`
#>   <bch:expr>         <bch:tm> <bch:tm>     <dbl>
#> 1 mean(x)              2.74µs   3.58µs   238187.
#> 2 mean.default(x)      1.38µs   1.56µs   597175.
#> 3 .Internal(mean(x))    299ns    316ns  2884958.
```
...
#>   expression              min   median `itr/sec`
#>   <bch:expr>         <bch:tm> <bch:tm>     <dbl>
#> 1 mean(x)              21.2µs   21.9µs    42754.
#> 2 mean.default(x)      19.7µs   20.1µs    49110.
#> 3 .Internal(mean(x))   18.3µs   18.4µs    53284.
```
...
#>   expression         min   median `itr/sec`
#>   <bch:expr>    <bch:tm> <bch:tm>     <dbl>
#> 1 as.data.frame   1.44ms   1.51ms      609.
#> 2 quick_df        9.39µs  10.72µs    85870.
```
...
#>   expression        min   median `itr/sec`
#>   <bch:expr>   <bch:tm> <bch:tm>     <dbl>
#> 1 lookup[x1]      517ns    666ns   900469.
#> 2 lookup[x10]    1.58µs   1.89µs   409798.
#> 3 lookup[x100]   4.77µs   6.53µs   153475.
```
...
#>   expression      min   median `itr/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl>
#> 1 loop10      37.52µs  40.56µs    23618.
#> 2 loop100    792.82µs 809.44µs     1183.
#> 3 vec10        6.77µs   7.51µs   120707.
#> 4 vec100      36.79µs  38.24µs    25423.
```
