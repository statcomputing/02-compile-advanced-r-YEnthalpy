...
```r
env_parents(e2b)
#> [[1]]   <env: 0x7ffa65f11068>
#> [[2]] $ <env: global>
env_parents(e2d)
#> [[1]]   <env: 0x7ffa65f9e498>
#> [[2]] $ <env: empty>
```
